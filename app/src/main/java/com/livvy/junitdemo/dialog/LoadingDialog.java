package com.livvy.junitdemo.dialog;
...
public class LoadingDialog {
    ...
    public LoadingDialog(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.loading_dialog_default_color);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
     ...
     * @param style One of the LoadingDialog.Style values
     * @return Current HUD
     */
